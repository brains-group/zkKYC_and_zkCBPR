...
export type ByteView<T> = import('@ipld/dag-pb/node_modules/multiformats/codecs/interface').ByteView<T>;
export type ArrayBufferView<T> = import('@ipld/dag-pb/node_modules/multiformats/codecs/interface').ArrayBufferView<T>;
